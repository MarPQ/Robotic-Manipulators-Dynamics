###########################################################################
## Makefile generated for Simulink model 'Act_1'. 
## 
## Makefile     : Act_1.mk
## Generated on : Tue Nov 17 18:56:20 2020
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Act_1.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Marco/DOCUME~1/MATLAB/SISTEM~4/ACTIVI~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Act_1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Act_1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Act_1.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Act_1_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Act_1 -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Act_1_grt_rtw/Act_1.c $(START_DIR)/Act_1_grt_rtw/Act_1_data.c $(START_DIR)/Act_1_grt_rtw/rtGetInf.c $(START_DIR)/Act_1_grt_rtw/rtGetNaN.c $(START_DIR)/Act_1_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Act_1.obj Act_1_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
